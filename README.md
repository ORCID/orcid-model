...
* [About Schema Updates and Versioning](#about-xsd-updates-and-versioning)
    * [Staying Informed](#staying-informed)
    * [Using XSD Versions](#using-xsd-versions)
* [Schema Versions Table](#orcid-message-xsd-versions)
...
| ------------ | ------------ | ----------- | ----- | -------------------------------- |
| [ORCID XSD 3.0](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_3.0) | May 16, 2019 | | **[Latest release version](#releaseVersion)**<br>**Current Supported version. Default version for API calls.** <br/>*New affiliation types Qualifications, Membership and service, Invited positions and distinctions. Research resources.Schema changes for posting information “on behalf of.”*|This is a preferred version. All developers should, if possible, be using or migrating to this version. [Documentation](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_3.0/README.md)|
| [ORCID XSD 2.1](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_2.1) | Nov 17, 2017 | | **[Supported Version](#releaseVersion)**<br>Supported version<br/>*ORCID iDs are expressed in the canonical form with the https prefix* |This is an older but fully supported version. 3.0 is the latest supported version. Use 3.0 for the latest features.<br>[Documentation](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_2.1/README.md)|
| [ORCID XSD 2.0](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_2.0) | Feb 13, 2017 | | **[Release version](#releaseVersion)**<br><br>Deprecated Version<br/>[Change log from 1.2](https://members.orcid.org/api/news/xsd-20-update) |This is a preferred version. All developers should be using or migrating to this version or 2.1. [Documentation](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_2.0/README.md)|
