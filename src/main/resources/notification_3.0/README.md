...
XML for the ```permission``` notifications follows the [notification-permission-3.0.xsd](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/notification_3.0/notification-permission-3.0.xsd) and consists of the following sections:
...
For an example XML file, see [notification-permission-3.0.xml](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/notification_3.0/samples/notification-permission-3.0.xml)
