...
##Peer Review XML
XML for the ```peer-review``` activity follows the [peer-review-2.0_rc4.xsd](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/record_2.0_rc4/peer-review-2.0_rc4.xsd) and consists of the following sections:
...
For an example XML file, see [peer-review-2.0_rc4.xml](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/record_2.0_rc4/samples/peer-review-2.0_rc4.xml )
