...
| ------------ | ------------ | ----------- | ----- | -------------------------------- |
| [ORCID XSD 3.0](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_3.0) | May 16, 2019 | | **[Release version](#releaseVersion)**<br><br>CURRENT SUPPORTED VERSION<br/>*ORCID iDs are expressed in the canonical form with the https prefix* |This is a preferred version. All developers should be using or migrating to this version. [Documentation](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_3.0/README.md)|
| [ORCID XSD 2.1](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_2.1) | Nov 17, 2017 | | **[Deprecated Version](#releaseVersion)**<br>Deprecated Version<br/>*ORCID iDs are expressed in the canonical form with the https prefix* |This is a deprecated version. All developers should be using or migrating to 3.0. [Documentation](https://github.com/ORCID/orcid-model/blob/master/src/main/resources/record_2.1/README.md)|
