...
## Peer Review XML
XML for the ```peer-review``` activity follows the [peer-review-2.0.xsd](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/record_2.0/peer-review-2.0.xsd) and consists of the following sections:
...
For an example XML file, see [peer-review-2.0.xml](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/record_2.0/samples/peer-review-2.0.xml )
