...
XML for the ```permission``` notifications follows the [notification-permission-2.1.xsd](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/notification_2.1/notification-permission-2.1.xsd) and consists of the following sections:
...
For an example XML file, see [notification-permission-2.1.xml](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/notification_2.1/samples/notification-permission-2.1.xml)
