...
##Peer Review XML
XML for the ```peer-review``` activity follows the [peer-review-2.0_rc2.xsd](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/record_2.0_rc2/peer-review-2.0_rc2.xsd) and consists of the following sections:
...
For an example XML file, see [peer-review-2.0_rc2.xml](https://github.com/ORCID/orcid-model/tree/master/src/main/resources/record_2.0_rc2/samples/peer-review-2.0_rc2.xml )
